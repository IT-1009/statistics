# 統計学の数式をコードで表しながら学ぶ
確率の難しさはイメージの難しさにあります。虚数なども実際に存在しませんが、図や表で表現することが出来ます。そのため視覚的に理解することが出来ますが、確率ではそうはいきません。またイメージが難しいという事は、勘が効きにくいとも言えます。そこでこの資料を読み、コードを動かすことで確率統計の理解を深めてもらえれば、と思っています。
